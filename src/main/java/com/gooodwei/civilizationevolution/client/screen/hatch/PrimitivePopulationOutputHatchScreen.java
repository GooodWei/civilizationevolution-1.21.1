 ...
 * 需要设计 hatch 输出接口专用 GUI 纹理。详见 {@code dontpush/gui_design_tasks.md}。</p>
 */
public class PrimitivePopulationOutputHatchScreen extends AbstractHatchScreen<PrimitivePopulationOutputHatchMenu> {

    /** TODO：替换为 hatch 人口输出专用纹理，当前为营地占位副本 */
    ...
    public PrimitivePopulationOutputHatchScreen(PrimitivePopulationOutputHatchMenu menu,
