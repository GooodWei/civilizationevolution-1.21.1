 ...
 */
public class VillageFoodInputHatchScreen extends AbstractHatchScreen<FoodInputHatchMenu> {

    /** TODO：替换为村庄食物输入专用纹理，当前为原始食物输入占位副本 */
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("civilizationevolution",
                    "textures/gui/container/village_food_input_hatch.png");

    public VillageFoodInputHatchScreen(FoodInputHatchMenu menu,
