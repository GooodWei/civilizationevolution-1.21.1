 ...
 * </ul>
 */
public class VillageCampMenu extends MachineMenu {
     ...
     * @param blockEntity     村庄营地方块实体
     */
    public VillageCampMenu(int containerId, Inventory playerInventory, VillageCampBlockEntity blockEntity) {
        super(MenuRegistry.VILLAGE_CAMP_MENU.get(), containerId);
     ...
     * @return 重建的 VillageCampMenu 实例
     */
    public static VillageCampMenu fromNetwork(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf buf) {
        VillageCampBlockEntity be = (VillageCampBlockEntity) playerInventory.player.level().getBlockEntity(buf.readBlockPos());
        return new VillageCampMenu(containerId, playerInventory, be);
    }
